...
--
-- Host: 127.0.0.1    Database: say_hospital_bd
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=1015164 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbb_personal` (
  ...
  CONSTRAINT `fk_personal_persona` FOREIGN KEY (`persona_id`) REFERENCES `tbb_personas` (`ID`)
...
CREATE TABLE `tbb_personal_medico` (
  ...
  KEY `idx_personal` (`personal_id`),
  KEY `fk_medico_area` (`area_id`),
  CONSTRAINT `fk_medico_area` FOREIGN KEY (`area_id`) REFERENCES `tbc_areas` (`ID`),
  CONSTRAINT `fk_medico_personal` FOREIGN KEY (`personal_id`) REFERENCES `tbb_personal` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1015269 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbd_horarios` (
  ...
  KEY `idx_personal` (`personal_id`),
  KEY `idx_area` (`area_id`),
  CONSTRAINT `fk_horario_area` FOREIGN KEY (`area_id`) REFERENCES `tbc_areas` (`ID`),
  CONSTRAINT `fk_horario_personal` FOREIGN KEY (`personal_id`) REFERENCES `tbb_personal` (`ID`),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_no_empalme_horario` BEFORE INSERT ON `tbd_horarios` FOR EACH ROW BEGIN
  IF EXISTS (
    SELECT 1
    FROM tbd_horarios
    ...
    SIGNAL SQLSTATE '45000'
    SET MESSAGE_TEXT = 'El horario se empalma con otro existente';
  END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2026-03-16 13:38:55
